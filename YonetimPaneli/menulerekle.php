...
if(isset($_SESSION["Yonetici"])){
    ...
    <form action="index.php?SKD=0&SKI=59" method="post" >
        <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
            <tr height="70">
                <td width="560" bgcolor="#FF9900" style="color: #FFFFFF;" align="left"><h3>&nbsp;MENU AYARLARI</h3></td>
            ...
            <tr>
                <td colspan="2"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                        <tr height="40">
                            ...
                            <td width="500">
                                <select name="UrunTuru" class="SelectAlanlari">
                                    ...
                                    <option value="Cocuk Ayakkabısı">Cocuk Ayakkabısı</option>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr height="40">
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><input type="submit" value="Menu Kaydet" class="YesilButon"></td>
                        </tr>
                    </table></td>
            </tr>
        </table>
