...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
    //distinct ile tüm siparişleri yakaladım
...
// bu döngüyü yapma sebebim tüm sipariş numaralarını alıp döngüye soktum siparişlerin hepsi döngüyle sıralanacak
	if($SiparisNumaralariSayisi>0){
		foreach($SiparisNumaralariKayitlari as $SiparisNumaralariSatirlar){
            ...
            //bu döngüyüde yukarıdaki döngünün tek tek  siparisin toplam tutarın tarihi hesaplamak için yaptım
			if($SiparisSayisi>0){
				$ToplamFiyat		=	0; // topam= 0  -> fiyatı sıfır olduğunda hata vermemsi için yazıyoruz altta siparislerden += toplatarak  hepsini toplu gösteriyorum
