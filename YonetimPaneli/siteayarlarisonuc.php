...
if(isset($_SESSION["Yonetici"])){
    ...
    <form action="index.php?SKD=0&SKI=2" method="post" enctype="multipart/form-data">
        <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
            <tr height="70">
                <td align="center" bgcolor="#FF9900" style="color: #FFFFFF;"><h3>&nbsp;SİTE AYARLARI</h3></td>
            </tr>
            <tr height="10">
            ...
            <tr>
                <td><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="40">
                            ...
                            <td>:</td>
                            <td><input type="text" name="SosyalLinkİnstegram" value="<?php echo DonusumleriGeriDondur($SosyalLinkInstegram); ?>" class="InputAlanlari"></td>
                        </tr>
                        <tr height="40">
