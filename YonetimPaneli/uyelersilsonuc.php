...
if(isset($_SESSION["Yonetici"])){
	...
	if($GelenID!=""){
//      üyeleri tamamiyle silmemek geri açabilmek için silinme durumunu değiştriip üyeyi aktiflikten kaldırıyorum
...
//          silinen üyenin sepetini siliyorum
			$SepetSilmeSorgusu		=	$VeritabaniBaglantisi->prepare("DELETE FROM sepet WHERE UyeId = ?");
			$SepetSilmeSorgusu->execute([$GelenID]);

//          yorumları üye silinince  puan durumu değişeceği ve birden çok yorumu silinince değişiklik göstericeği için tekrardan  döngüye sokarak  hesaplatıyorum
