...
if(isset($_SESSION["Kullanici"])){
    ...
    // sanal post  başlangıç ------     cliendid ,storekey vb değişkenleri ayar.php den çektik
    ...
    $okUrl			=	"http://www.siteadiniz.com/alisverissepetikredikartiodemetamam.php";	//	Ödeme İşlemi Başarıyla Gerçekleşir ise Dönülecek Sayfa
    $failUrl		=	"http://www.siteadiniz.com/alisverissepetikredikartiodemehata.php";	//	Ödeme İşlemi Red Olur ise Dönülecek Sayfa
    $rnd			=	@microtime();
                ...
                <tr>
                    <td width="800" valign="top" >
                        <table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr height="30">
                                <td valign="top" style="border-bottom: 1px dashed #CCCCCC;">Kredi Kartı Bilgilerini Belirtip Ödeme Yapabilrisiniz</td>
                            </tr>
                            <tr height="10">
