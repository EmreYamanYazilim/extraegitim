...
if (isset($_SESSION["Kullanici"])){
    ...
    if (($GelenIsimSoyisim!="") and  ($GelenAdres!="") and ($GelenIlce!="") and ($GelenSehir!="") and ($GelenTelefonNumarasi!="")){
        ...
        $AdresEklemeSorgusu   =     $VeritabaniBaglantisi->prepare("INSERT INTO adresler (UyeId, AdSoyad, Adres, Ilce, Sehir, TelefonNumarasi) values (?,?,?,?,?,?)");
        $AdresEklemeSorgusu->execute([$KullaniciID, $GelenIsimSoyisim, $GelenAdres, $GelenIlce, $GelenSehir, $GelenTelefonNumarasi]); //ID ayalar.phpden geliyor
